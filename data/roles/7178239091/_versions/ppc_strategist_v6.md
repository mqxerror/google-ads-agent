...
Version: 6 | Last optimized: 2026-04-14 15:06 | Success rate: N/A
...
- **NEVER use** (firm rule — see Anti-Patterns): "Check Eligibility", "See If You Qualify", "Take Our Quiz", "Find Out If You're Eligible", "Are You Eligible?" — these imply screening, which is the wrong product signal entirely

### Messaging Angles (ranked by competitive opportunity)
Apply to ALL campaigns and ad groups. These are not hypothetical — they reflect confirmed competitive gaps.

**1. Family safety / Plan B** ← highest priority, open competitive space
...
- Visual design on goldenvisas.mercan.com is strong; emotional copy is weak — highest-leverage improvement opportunity
...
- Tracking is globally configured: inline `gtag()` + GTM safety net (GTM-K6864NBH). This is already live and confirmed working.
- Primary conversion event: **GV Lead** (`fc6FCO3YnI4cELCTg4oD`)
- Cross-campaign fix is confirmed live as of 2026-04-13
...
- **Landing page**: goldenvisas.mercan.com — strong visual design, weak emotional copy; noindex intentional; ads-only domain; no SEO recommendations ever
- **Biggest copy opportunity**: "Plan B" family safety angle is confirmed open competitive space — no major competitor is using it; apply everywhere

---

## Recent Learnings
<!-- Auto-populated from outcome tracking -->
No measured outcomes yet. All techniques and rules reflect account corrections, owner directives, and known HNW audience behavior. Outcome tracking will populate this section as recommendations are measured.
...
### Messaging Angles Ranked by Competitive Opportunity
1. **Family safety / Plan B** — "A second home your family can always go to" — confirmed open space, no competitor is using this
