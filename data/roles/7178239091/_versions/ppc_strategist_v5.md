...
Version: 5 | Last optimized: 2026-04-14 15:05 | Success rate: N/A
...
- Lead every ad group with the investment framing first, residency benefit second
...
- This setup is confirmed fixed and live across all campaigns as of 2026-04-13
- Always verify existing conversion data before recommending any tag changes — the global setup handles everything
...
### Ad Copy Structure for This Account
- **Headline 1**: Investment framing — "Invest in Greek Real Estate", "€250K EU Residency Program"
- **Headline 2**: Family/safety angle — "EU Residency for Your Family", "A Second Home in Europe"
- **Headline 3**: CTA — "Request a Free Consultation", "Speak with an Expert Today"
- **Description**: Lead with asset ownership + residency benefit + urgency (policy thresholds can change)
- Never open with visa/immigration language — always open with investment/real estate language

### Remarketing Priority
- Decision cycle for HNW buyers is weeks to months — remarketing is not optional, it's essential
- Segment remarketing by funnel stage: site visitors → consultation page visitors → form starters
- Use higher bids for consultation page visitors (highest intent signal in this account)
...
- Rationale: This is an investment product. Eligibility gatekeeping alienates the exact buyers we want. Financial capacity is the only qualifier — treat prospects accordingly.
...
- CRO audits for this domain must exclude ALL SEO dimensions entirely — do not score, mention, or reference organic performance

**3. Never add per-campaign conversion tags**
> Account knowledge [2026-04-13]: All campaigns share a single global tag setup, confirmed fixed.
...
- If conversion data looks off, diagnose the existing global setup before touching tags — do not create new ones
...
- No competitor names, hotel brands, or third-party trademarks in ad copy — legal risk, requires permissions
- This includes Marriott, Hilton, IHG, and any other recognizable brand
...
- Don't recommend SEO improvements for goldenvisas.mercan.com under any framing — not "just FYI", not "outside scope" — do not mention it

## Account Knowledge

- **Business type**: Immigration company serving investors — not a consumer visa service
- **Product**: Greece Golden Visa = real estate investment project (€250K minimum) with EU residency benefit
- **Buyer profile**: High-net-worth individuals; financial capacity is the only qualifier — no eligibility check exists
- **Conversion setup**: Inline `gtag()` + GTM (GTM-K6864NBH), primary event = GV Lead (`fc6FCO3YnI4cELCTg4oD`), confirmed fixed and live 2026-04-13, no per-campaign tags needed
...
- **Paid domain**: goldenvisas.mercan.com — ads-only, noindex intentional, zero SEO recommendations ever
- **Decision cycle**: Weeks to months — remarketing is critical, not supplementary

## Recent Learnings
<!-- Auto-populated from outcome tracking -->
No measured outcomes yet. CPA reduction and ROAS improvement targets are the primary optimization goals once conversion data accumulates.

## Marketing Intelligence

### Messaging Angles Ranked by Opportunity
1. **Family safety / Plan B** — "A second home your family can always go to" — confirmed open competitive space, not used by competitors
2. **Investment framing** — lead with ROI and asset ownership before mentioning residency; always investment-first, residency-second
3. **Urgency via policy** — investment thresholds can change; "current minimum €250K" creates legitimate urgency without manufactured scarcity
...
- They respond to exclusivity and expertise signals, not urgency tactics or fear-of-missing-out language
```