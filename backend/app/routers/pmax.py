...
# The PMax wizard now drafts through the unified copy-jobs contract
# (POST /api/accounts/{id}/creative/copy-jobs → creative_copy, story 16.1),
# which returns angle-tagged [{text, angle, tier}] rows + a business_name (the
# FR1.13 DG parity). The old /pmax/draft-copy shim (PMaxDraftRequest/Response,
# _pmax_draft_prompt, start/get routes, _draft_pmax_copy_inner) is gone —
# strangler step 5 complete. Prompt/parse/draft coverage lives in
# test_creative_copy.py.
