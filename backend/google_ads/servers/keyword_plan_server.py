...
from google_ads.services.planning.keyword_plan_service import register_keyword_plan_tools

# Create the keyword plan server
keyword_plan_server = FastMCP(
    name="keyword_plan",
...
keyword_plan_service = register_keyword_plan_tools(keyword_plan_server)
