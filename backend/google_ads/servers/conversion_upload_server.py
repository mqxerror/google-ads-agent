...
from google_ads.services.conversions.conversion_upload_service import (
    register_conversion_upload_tools,
)

# Create the conversion upload server
conversion_upload_server = FastMCP(
...
conversion_upload_service = register_conversion_upload_tools(conversion_upload_server)
