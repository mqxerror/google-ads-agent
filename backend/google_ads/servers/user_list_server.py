...
from google_ads.services.audiences.user_list_service import register_user_list_tools

# Create the user list server
user_list_server = FastMCP(
    name="user_list",
...
user_list_service = register_user_list_tools(user_list_server)
