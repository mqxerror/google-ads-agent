...
from google_ads.services.shared.shared_criterion_service import (
    register_shared_criterion_tools,
)

# Create the shared criterion server
shared_criterion_server = FastMCP(
...
shared_criterion_service = register_shared_criterion_tools(shared_criterion_server)
