...
from google_ads.services.metadata.google_ads_field_service import (
    register_google_ads_field_tools,
)

# Create the Google Ads field server
google_ads_field_server = FastMCP(
...
google_ads_field_service = register_google_ads_field_tools(google_ads_field_server)
