...
from google_ads.services.conversions.customer_conversion_goal_service import (
    register_customer_conversion_goal_tools,
)

# Create the FastMCP instance for customer conversion goal
customer_conversion_goal_server = FastMCP(
...
register_customer_conversion_goal_tools(customer_conversion_goal_server)
