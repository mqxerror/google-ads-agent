...
- **Model Selector** — Switch between Fable 5 (deepest, default — `claude-fable-5[1m]`, with automatic fallback to Opus 5 / `claude-opus-5` on a usage/rate limit), Sonnet (fast), Opus (deep analysis), Haiku (quick/cheap)
